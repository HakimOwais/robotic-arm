...
from ros2_basics.py_minimal_publisher import MinimalPyPublisher
...
def test_publisher_creation():
    ...
    try:
        ...
        assert node.publisher_1.topic_name.endswith('py_example_topic')
    finally:
...
def test_message_content():
    ...
    try:
        ...
        msg.data = f'Hello Owais, How are you?: {node.i}'

        assert msg.data == 'Hello Owais, How are you?: 5'
